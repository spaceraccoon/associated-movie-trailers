...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on('click', '.hanging-close, .modal-backdrop, .modal', function (event) {  # NOQA
            // Remove the src so the player itself gets removed, as this is the only  # NOQA
        ...
        $(document).on('click', '.movie-tile', function (event) {
            ...
            var sourceUrl = 'http://www.youtube.com/embed/' + trailerYouTubeId + '?autoplay=1&html5=1';  # NOQA
            $("#trailer-video-container").empty().append($("<iframe></iframe>", {  # NOQA
              'id': 'trailer-video',
              'type': 'text-html',
              'src': sourceUrl,
              'frameborder': 0
...
main_page_footer = '''
  <footer class="footer">
    <div class="container">
      <p class="text-muted">
        <img src="https://www.themoviedb.org/assets/static_cache/23e473036b28a59bd5dcfde9c671b1c5/images/v4/logos/312x276-primary-green.png" width="auto" height="24px">  # NOQA
